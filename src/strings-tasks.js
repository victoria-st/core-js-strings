...
function removeLastOccurrences(str, value) {
  ...
  const part1 = str.slice(0, lastOccurrenceIndex);
  const part2 = str.slice(lastOccurrenceIndex + value.length);
  return part1 + part2;
}
...
function orderAlphabetically(str) {
  const stringToArray = str.split('');
  const sortedArray = stringToArray.sort();
  const arrayToString = sortedArray.join('');
  return arrayToString;
}
...
function isPalindrome(str) {
  ...
  const stringToArray = strInLowerCase.split('');
  const reversedArray = stringToArray.reverse();
  const arrayToString = reversedArray.join('');
  return strInLowerCase === arrayToString;
}
